...
<main class="stage" id="stage">
  ...
  <section class="aws-architecture aws-architecture-page" id="awsArchitecture" aria-label="AWS architecture">
    ...
    <div class="aws-architecture-flow">
      ...
      <i class="aws-wire">→</i>
      <div class="aws-column"><div class="aws-column-label">ENTRY</div><div class="aws-node" data-service="api"><small>HTTP API</small><strong>API Gateway</strong><span>Browser requests</span></div><div class="aws-node aws-node-event"><small>SCHEDULE</small><strong>EventBridge</strong><span>Hourly trigger · disabled</span></div></div>
      <i class="aws-wire">→</i>
