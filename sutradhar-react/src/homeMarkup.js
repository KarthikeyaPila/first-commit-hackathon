...
<main class="stage" id="stage">
    ...
    <div class="flank flank-l">
      <div class="national-cta">
        <button class="national-btn" id="nationalBtn" type="button">
          ...
          <span class="national-btn-hint">Get national news</span>
  ...
  <section class="aws-architecture aws-architecture-page" id="awsArchitecture" aria-label="AWS architecture">
    ...
    <div class="aws-architecture-flow">
      <div class="aws-column"><div class="aws-column-label">DELIVERY</div><div class="aws-node aws-node-main" data-service="s3"><small>STATIC WEBSITE HOSTING</small><strong>S3</strong><span>Frontend assets · live HTTP endpoint</span></div><div class="aws-node aws-node-event" data-service="s3"><small>OBJECT STORAGE</small><strong>S3 bucket</strong><span>Compiled app files</span></div></div>
      <i class="aws-wire">→</i>
      <div class="aws-column"><div class="aws-column-label">ENTRY</div><div class="aws-node" data-service="api"><small>HTTP API</small><strong>API Gateway</strong><span>Browser requests</span></div><div class="aws-node aws-node-event"><small>SCHEDULE</small><strong>EventBridge</strong><span>Hourly trigger · enabled</span></div></div>
      <i class="aws-wire">→</i>
      <div class="aws-column aws-column-lambda"><div class="aws-column-label">COMPUTE · LAMBDA</div><div class="aws-node" data-service="api"><small>AWS::SERVERLESS::FUNCTION</small><strong>ApiFunction</strong><span class="aws-handler">first_commit.lambda_handlers.api_handler</span></div><div class="aws-node aws-node-main" data-service="processing"><small>AWS::SERVERLESS::FUNCTION</small><strong>ProcessingFunction</strong><span class="aws-handler">first_commit.lambda_handlers.processing_handler</span></div></div>
      <i class="aws-wire">→</i>
      <div class="aws-column"><div class="aws-column-label">PERSISTENCE</div><div class="aws-node" data-service="dynamo"><small>STORAGE</small><strong>DynamoDB</strong><span>Runs + articles</span></div><div class="aws-node aws-node-event"><small>FAILURE CAPTURE</small><strong>SQS</strong><span>ProcessingFailureQueue</span></div></div>
    </div>
    <div class="aws-architecture-support"><span><b>Frontend</b> → S3 static website hosting</span><span><b>EventBridge Schedule</b> → ProcessingFunction · hourly enabled</span><span><b>SQS ProcessingFailureQueue</b> · retry capture</span></div>
  </section>
