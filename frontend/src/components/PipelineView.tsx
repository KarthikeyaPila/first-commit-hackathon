...
export function PipelineView({ onClose }: { onClose: () => void }) {
  ...
  return <section className="pipeline-view-live" role="dialog" aria-modal="true" aria-label="Sutradhar processing pipeline">
    <header className="pipeline-live-head"><div><span className="micro">Sutradhar · control system</span><h2>Look inside.</h2></div><button className="close-button dark" type="button" onClick={onClose}>Return to press ×</button></header>
