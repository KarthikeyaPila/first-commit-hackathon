...
function App() {
  ...
  return <div className="app-root">
    ...
    <div className="overture" data-done={overture ? "0" : "1"} aria-hidden={!overture}><div className="ov-mark">SUTRADHAR</div><div className="ov-sub micro">Drawing India, state by state</div><div className="ov-track"><i /></div></div>
